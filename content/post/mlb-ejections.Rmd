...
The most penalized division is the AL East with 388 ejections over 10 years. On average a team will receive `r round(mean(divisions$n)/10,2)` ejections per season.  The top five teams with the most ejections are listed below.
