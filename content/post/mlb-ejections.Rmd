...
Arguing safe/out sharply declined after having the ability to challenge calls before going extinct in 2016.  A new type of ejection emerged as a result though.  Issues with the replay ruling or why a challenge was or was not granted seemed to fill the gap.  The "other" category references plays regarding interfence, balks, and everything else.  Perhaps what is most noteworthy, is that from 2013 to 2017 the percentage of yearly ejections via agruing balls/strikes (which also includes check swings) is up 17%.  The trust in an umpire's ability to manage the strike zone seems to be at least shrinkng some.  If that number doesn't decrease anytime soon, I wouldn't be surprised to see the automated strike zone make its debut sooner rather than later.  
...
It's often said during a broadcast that after a manager is ejected, they'll pay attention to how the players respond.  The team will either take the lead (positive outcome), lose the lead (negative outcome), or remain ahead/behind (neutral outcome).  The graph below plots all outcomes against each other among managers with 6 or more ejections the past 10 years.
