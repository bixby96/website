...
<iframe src = "https://chadbixby.shinyapps.io/kanye-song-attributes/"></iframe>

Interested in exploring the rest of the variables?  Select which albums to compare and choose which characterisics using the interactive plot [here](https://chadbixby.shinyapps.io/kanye-song-attributes/)!
...
The most popular songs don't appear to belong to any specific area or cluster on the graph, but it does look like `Energy` and `Loudness` are fairly correlated.  Try graphing them using the interactive plot linked above! (or right [here](https://chadbixby.shinyapps.io/kanye-song-attributes/))
