...
With a valence score of 14.68, the happiest Kanye release came way back in 2004 with his debut hit *The College Dropout*.  Interestingly, the four albums with the lowest valence score also make up his most recent work.  Check out the the 
...
kable(head(kanye_valence_songs,10), caption = "Top 10 Valence") %>%
