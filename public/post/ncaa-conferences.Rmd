...
#Introduction
With the recent start of the college basketball season, I thought it would be interesting to explore how style of play varies between conferences and reveal how the game has changed over time.  Using yearly [kenpom.com](https://kenpom.com/) data, a site for advanced college basketball stats, I examined the state of college hoops.  
